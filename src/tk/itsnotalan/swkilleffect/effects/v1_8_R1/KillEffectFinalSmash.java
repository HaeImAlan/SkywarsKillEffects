...
public class KillEffectFinalSmash extends KillEffect {
	...
	public void play(Player p) {
		...
		net.minecraft.server.v1_8_R1.ItemStack nmsSkull = CraftItemStack.asNMSCopy(skull);
		net.minecraft.server.v1_8_R1.ItemStack nmsChest = CraftItemStack.asNMSCopy(chest);
		net.minecraft.server.v1_8_R1.ItemStack nmsLeg = CraftItemStack.asNMSCopy(leg);
		net.minecraft.server.v1_8_R1.ItemStack nmsBoots = CraftItemStack.asNMSCopy(boots);
